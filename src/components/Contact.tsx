      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl lg:text-6xl font-orbitron font-bold text-foreground mb-6">
            Let's Build the
            <span className="bg-gradient-warm bg-clip-text text-transparent block glow-orange">
              Future Together
            </span>
          </h2>
          
          <p className="text-lg text-muted-foreground leading-relaxed mb-12 max-w-2xl mx-auto">
            I'm always open to discussing innovative projects, creative ideas, or opportunities 
            to be part of ambitious visions. Whether you have a groundbreaking concept or just 
            want to explore the possibilities of AI, my inbox is always open.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="glass-effect rounded-xl p-6 hover-lift border border-primary/20 group">
              ...
              <h3 className="font-orbitron font-bold text-foreground mb-2">Email</h3>
              <p className="text-muted-foreground text-sm">vedantams18@gmail.com</p>
            </div>
            ...
            <div className="glass-effect rounded-xl p-6 hover-lift border border-primary/20 group">
              ...
              <h3 className="font-orbitron font-bold text-foreground mb-2">LinkedIn</h3>
            ...
            <div className="glass-effect rounded-xl p-6 hover-lift border border-primary/20 group">
              ...
              <h3 className="font-orbitron font-bold text-foreground mb-2">GitHub</h3>
          ...
          <Button 
            ...
            asChild
          >
            <a href="mailto:vedantams18@gmail.com">
              INITIATE CONTACT
            </a>
          </Button>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <Button 
              ...
              asChild
            >
              <a href="https://www.linkedin.com/in/vedanta-m-s-14035b245" target="_blank" rel="noopener noreferrer">
                LinkedIn Connect
              </a>
            </Button>
            ...
            <Button 
              ...
              asChild
            >
              <a href="https://github.com/iamVedanta" target="_blank" rel="noopener noreferrer">
                View GitHub
              </a>
            </Button>
          </div>
        ...
        <div className="absolute bottom-10 right-10 w-24 h-24 bg-gradient-secondary rounded-full opacity-10 animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
    </section>
  );
};

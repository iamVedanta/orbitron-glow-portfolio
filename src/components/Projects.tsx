  ...
  const projects = [
    {
      ...
      description: "Developing a GPS-independent navigation system for an autonomous drone, specifically designed for Martian terrain exploration using computer vision and advanced robotics.",
      image: droneProject,
      technologies: ["Python", "Computer Vision", "Robotics", "Machine Learning"],
      gradient: "bg-gradient-primary"
    },
    {
      title: "Neonatal Sleep-Wake Classification",
      description: "Utilized advanced models like YOLOv8 and Vision Transformers, fine-tuned for accurate sleep-wake state classification in neonates for medical monitoring applications.",
      image: aiProject,
    ...
    },
    {
      ...
      description: "A comprehensive machine learning project to analyze Indian election data, providing deep insights into electoral trends, voter behavior patterns, and predictive analytics.",
    ...
    <section id="projects" className="py-24">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-orbitron font-bold mb-12 flex items-center">
          ...
          <span className="bg-gradient-warm bg-clip-text text-transparent ml-2">Projects</span>
        </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className={`absolute top-4 right-4 w-12 h-12 ${project.gradient} rounded-full flex items-center justify-center group-hover:animate-pulse-glow`}>
                  <span className="text-white font-orbitron font-bold text-sm">AI</span>
                </div>
              </div>
